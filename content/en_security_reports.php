    ...
    <div id="content">
        ...
        <div class="sect2">
            ...
            <div class="olist arabic">
                <ol class="arabic">
                    <li>
                        <p>On receipt of a security report via <em>security@webtide.com</em> or other channels, if it cannot be trivially dismissed (already fixed, known not a problem, etc.), then a Github security advisory is created by project leadership.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>If enough information exists to attempt reproduction or fix, then a private repository is created.</p>
                    </li>
                    <li>
                        <p>If the vulnerability cannot be confirmed then close the security advisory, else continue.</p>
                    </li>
                    <li>
                        <p>Generate a CVE score and add to the advisory description.</p>
                    </li>
                    <li>
                        <p>Identify a CWE Definition and add to the advisory description</p>
                    </li>
                    <li>
                        <p>Identify vulnerable version(s).</p>
                    </li>
                    <li>
                        <p>Identify workaround(s).</p>
                    </li>
                    <li>
                        <p>Open an Eclipse Bugzilla to get a CVE allocated, cite CWE, and a short description of the vulnerability including versions affected.</p>
                    </li>
                    <li>
                        <p>Build and test fix(es).</p>
                    </li>
                    <li>
                        <p>Once the CVE is allocated update the Security Advisory with the number</p>
                    </li>
                    <li>
                        <p>Once a fix is available, continue:</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p>Edit release on Github to identify CVE number.</p>
                    </li>
                </ol>
            </div>
        </div>
