...
<div id="midcolumn">
  ...
  <ul>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-announce">jetty-announce@eclipse.org</a> - A mail list for the Jetty team to announce new versions of Jetty and events related to Jetty. Subscribe to this list if you are interested in this information. Please be aware that only Jetty committers can make announcements, so all other subscribers please do not post to this list.</p>
  <div class="ulist">
  <ul>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-announce">Subscribe/unsubscribe</a> instructions</p>
  </li>
  <li>
  <p><a href="http://dev.eclipse.org/mhonarc/lists/jetty-announce/maillist.html">Mailing list archive</a></p>
  </li>
  </ul>
  </div>
  </li>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-users">jetty-users@eclipse.org</a> - A mail list for user discussion.</p>
  <div class="ulist">
  <ul>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-users">Subscribe/unsubscribe</a> instructions</p>
  </li>
  <li>
  <p><a href="http://dev.eclipse.org/mhonarc/lists/jetty-users/maillist.html">Mailing list archive</a></p>
  </li>
  </ul>
  </div>
  </li>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-dev">jetty-dev@eclipse.org</a> - A mail list for developer discussion.
  It&#8217;s a place, where Jetty committers, contributors and integrators discuss all topics related to project development.</p>
  <div class="ulist">
  <ul>
  <li>
  <p><a href="https://dev.eclipse.org/mailman/listinfo/jetty-dev">Subscribe/unsubscribe</a> instructions</p>
  </li>
  <li>
  <p><a href="http://dev.eclipse.org/mhonarc/lists/jetty-dev/maillist.html">Mailing list archive</a></p>
  </li>
  <li>
  <p><a href="http://dev.eclipse.org/mhonarc/lists/jetty-dev/maillist.rss">RSS Feed</a></p>
  </li>
  </ul>
  </div>
  </li>
